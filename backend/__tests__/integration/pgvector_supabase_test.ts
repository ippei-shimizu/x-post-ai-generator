  ...
  async function setupTestData() {
    try {
      ...
      const testEmbeddings = [
        {
          user_id: testUser1Id,
          content_text: 'User 1 test content - React hooks and TypeScript patterns',
        ...
        {
          user_id: testUser1Id,
          content_text: 'User 1 test content - AWS Lambda serverless architecture',
          embedding: createTestVector(),
          source_type: 'test',
          model_name: 'test-embedding-model',
          metadata: {
        ...
        {
          user_id: testUser2Id,
          content_text: 'User 2 test content - PostgreSQL database optimization',
          embedding: createTestVector(),
          source_type: 'test',
          model_name: 'test-embedding-model',
          metadata: {
